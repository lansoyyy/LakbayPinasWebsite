          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Philippines Visa Requirements', style: GoogleFonts.poppins(fontSize: isMobile ? 28 : 40, fontWeight: FontWeight.w700, color: const Color(0xFF0D47A1))),
                ...
                _section(context, 'Visa-Free Entry', 'Most ASEAN and many Western nationals receive 30-day visa-free entry. Proof of onward travel may be required.'),
                const SizedBox(height: 12),
                _section(context, 'Extensions', 'You can extend tourist stays at Bureau of Immigration offices. Fees apply; allow processing time.'),
                const SizedBox(height: 12),
                _section(context, 'Documents', 'Valid passport (6+ months), onward/return ticket, proof of funds/accommodation may be requested.'),
                const SizedBox(height: 24),
