          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Philippines Travel Itineraries (7/10/14 days)', style: GoogleFonts.poppins(fontSize: isMobile ? 28 : 40, fontWeight: FontWeight.w700, color: const Color(0xFF0D47A1))),
                const SizedBox(height: 16),
                Text('Curated routes for first-timers and repeat visitors—connect islands efficiently while balancing beaches, culture, and nature.', style: GoogleFonts.poppins(fontSize: isMobile ? 16 : 18, height: 1.6, color: Colors.grey[800])),
                const SizedBox(height: 24),
                _itin(context, '7-Day Highlights', 'Manila → Palawan (El Nido) → Cebu/Bohol: lagoons, beaches, and Chocolate Hills.'),
                const SizedBox(height: 12),
                _itin(context, '10-Day Adventure', 'Manila → Siargao → Cebu → Bohol: surf, canyons, waterfalls, and island vibes.'),
                const SizedBox(height: 12),
                _itin(context, '14-Day Explorer', 'Manila → Palawan → Cebu → Siargao → Banaue: from lagoons to rice terraces.'),
                const SizedBox(height: 24),
