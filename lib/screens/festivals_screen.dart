          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    'Vibrant and colorful celebrations happen year-round across the Philippines, showcasing local culture, faith, and community.',
                    style: GoogleFonts.poppins(
                        fontSize: isMobile ? 16 : 18,
                        height: 1.6,
                        color: Colors.grey[800])),
                const SizedBox(height: 24),
                _festival(context, 'Sinulog (Cebu)',
                    'January: Grand street dancing in honor of Santo Niño.'),
                const SizedBox(height: 12),
                _festival(context, 'Ati-Atihan (Kalibo)',
                    'January: Tribal costumes, drums, and parades.'),
                const SizedBox(height: 12),
                _festival(context, 'Panagbenga (Baguio)',
                    'February–March: Flower festival and parades.'),
                const SizedBox(height: 24),
