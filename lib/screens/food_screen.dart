          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    'Taste the Philippines through its iconic dishes—from adobo and sinigang to lechon, halo-halo, and street food favorites.',
                    style: GoogleFonts.poppins(
                ...
                _dish(context, 'Adobo',
                    'A savory classic of meat braised in soy sauce, vinegar, garlic, and spices.'),
                const SizedBox(height: 12),
                _dish(context, 'Sinigang',
                    'Tamarind-based sour soup with pork, shrimp, or fish and vegetables.'),
                const SizedBox(height: 12),
                _dish(context, 'Lechon',
                    'Crispy whole roasted pig, a festive favorite.'),
                const SizedBox(height: 12),
                _dish(context, 'Halo-Halo',
                    'A refreshing dessert of shaved ice, milk, and mixed sweets.'),
                const SizedBox(height: 24),
